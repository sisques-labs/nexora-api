module.exports = {
  ...
  settings: {
    ...
    // Bounded-context boundary enforcement — same rule as nestjs-template/gardenia-api.
            ...
            paths: [
              {
                name: '@nestjs/testing',
                message:
                  'Unit tests must use manual instantiation (jest.Mocked<T>). @nestjs/testing is for e2e/integration tests only.',
              },
            ],
          },
        ],
